...
(function() {
  ...
  ValueTracker.prototype = {
    ...
    set hasDependents(hasDependents) {},

    set dependents(dependents) {
      var hadDependents = !!this.dependents_;
      var hasDependents = dependents;
      this.dependents_ = dependents;

      if (hasDependents != hadDependents)
        this.hasDependents = hasDependents;
    },

    get dependents() { return this.dependents_; },
