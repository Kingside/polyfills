...
// TODO(sorvell): normalize text addBinding to newer design
function addTextBinding(binding) {
  addBinding.call(this, 'textContent', binding);
}

function removeTextBinding(binding) {
  removeBinding.call(this, 'textContent', binding);
}
  ...
  if (object instanceof Element) {
    ...
    switch (kind) {
      ...
      case (AttributeKind.EVENT_HANDLER):
        return JS_PROP;
      // TODO(sorvell): make unknown attributes bind to attributes
